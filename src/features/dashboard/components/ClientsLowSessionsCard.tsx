        ...
        <div className="flex flex-col gap-0.5">
          {clients.map((c) => (
            <button
              ...
              className="flex items-center justify-between gap-2 px-3 py-2 rounded-lg text-left hover:bg-accent/10 hover:text-foreground transition-colors duration-200"
            >
