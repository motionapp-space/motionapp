...
export const ExerciseTableHeader = ({ visible }: ExerciseTableHeaderProps) => {
  ...
  return (
    <div className="hidden sm:grid sm:grid-cols-[32px_1fr_60px_60px_70px_60px_40px_40px] items-center gap-1 px-2 py-1 text-[11px] uppercase tracking-wider text-muted-foreground/60 border-b border-border/15">
