      ...
      <div className="hidden sm:grid sm:grid-cols-[32px_minmax(360px,1.6fr)_64px_88px_140px_72px_minmax(110px,0.7fr)_minmax(110px,0.7fr)_40px] items-start gap-1 py-3 px-2 border-b border-border/50 hover:bg-muted/45 transition-colors">
        ...
        {(isEditingName || !exercise.name || isFocusedRef.current) ? (
          <Input
            ...
            disabled={readonly}
            className="h-8 text-sm font-medium border border-transparent bg-transparent transition-colors hover:bg-muted/40 focus:border-primary/40 focus:ring-0 max-w-[260px] md:max-w-[320px]"
        ...
        <Input
          ...
          disabled={readonly}
          className="h-8 text-sm text-left pl-2 border border-transparent bg-transparent transition-colors hover:bg-muted/65 focus:border-primary/40 focus:ring-0 disabled:text-foreground disabled:opacity-100"
          min={1}
          max={99}
          aria-label="Serie"
        />
